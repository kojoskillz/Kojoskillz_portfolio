...
const Skeleton3 = () => (
  <div className="w-[calc(100%)] mx-auto rounded-md md:h-[20rem] h-[20rem] overflow-hidden" id='contact'>
      <Vortex
        backgroundColor="black"
        className="flex items-center flex-col justify-center px-2 md:px-10 py-4 w-full h-full"
      >
       
       <h1 className="text-white text-center font-bold md:text-4xl text-5xl">
          Imagine It
       </h1>
