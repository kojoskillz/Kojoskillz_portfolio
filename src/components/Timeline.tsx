  ...
  const data = [
    {
      ...
      content: (
        <div>
          ...
          <p className="text-white dark:text-neutral-200 text-lg md:text-sm xl:text-xl  font-normal mb-8">
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-white dark:text-neutral-200 text-lg md:text-sm font-normal xl:text-xl  mb-8">
    ...
    },
    {
      ...
      content: (
        ...
        <h1 className="text-cyan-300 uppercase dark:text-neutral-200 text-xl font-bold md:text-sm xl:text-4xl  mb-4">
          ...
          <div className="mb-8">
            <h1 className="text-white xl:text-xl ">
