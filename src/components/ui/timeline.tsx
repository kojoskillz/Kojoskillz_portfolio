...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
    className="w-full absolute mb-20 mt-[6rem] bg-black md:z-40 sm:z-40 lg:z-40 xl:z-40 z-40 xs:absolute sm:absolute md:absolute lg:absolute dark:bg-neutral-950  xs:mt-[15rem] sm:mt-[18rem] md:mt-[18rem] lg:mt-[8rem] xl:mt-[8rem] font-sans md:px-10"
    ref={containerRef}
  >
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block md:text-3xl text-2xl mb-4 text-left font-bold text-neutral-500 dark:text-neutral-500">
                {item.title}
              </h3>
              {item.content}{""}
            </div>
