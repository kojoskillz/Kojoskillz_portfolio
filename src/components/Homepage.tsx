...
export  function SparklesPreview() {
  return (
    <div id='Home' className="h-[50rem] w-full pt-20 bg-black flex flex-col items-center justify-center overflow-hidden rounded-none mb-10">
            <div>
               <h1 className=' focus-in-contract  font-sans  text-wrap stroke  text-[2.5rem] inset-20 font-extrabold text-blur-out'>
                   Hey there, meet
               </h1>
            </div>
        
      <h1 className="md:text-7xl permanent_marker xs:text:[10rem] text-[4.5rem] tracking-tighter leading-[4rem]  text-wrap sm:font-extrabold xs:font-extrabold md:font-extrabold lg:font-extrabold  lg:text-9xl font-extrabold text-center  bg-gradient-to-r from-[#00aeff] to-[#51e2ff]  inline-block  text-transparent bg-clip-text ">
        KWADWO <br /> NYARKO
      </h1>
