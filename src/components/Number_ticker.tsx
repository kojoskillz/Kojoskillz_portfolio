...
const  NumberTickerDemo = () => {
  return (
    ...
    <p className="whitespace-pre-wrap text-8xl m-auto xl:flex lg:flex md:flex sm:grid xs:grid grid place-content-center overflow-x-hidden overflow-y-hidden gap-10 font-medium tracking-tighter bg-black   text-white dark:text-white">
